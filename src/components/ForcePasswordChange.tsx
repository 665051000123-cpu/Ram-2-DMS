    ...
    <div className="fixed inset-0 bg-slate-900/80 flex items-center justify-center z-[9999] p-4 backdrop-blur-md">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-8 text-center relative overflow-hidden">
          ...
          <h2 className="text-2xl font-bold text-white mb-2 relative z-10">เปลี่ยนรหัสผ่าน</h2>
          <p className="text-indigo-100 text-sm relative z-10">
            เพื่อความปลอดภัยของข้อมูล กรุณาตั้งรหัสผ่านใหม่สำหรับการเข้าใช้งานครั้งแรก
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5 bg-white">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all focus:bg-white"
